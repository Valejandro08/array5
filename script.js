...
if (mood=== "happy"){recommendedSong= "Here comes the sun by The Beatles";}
else if (mood === "sad") {recommendedSong= "Someone like you by Adele";}
else if (mood !== "happy" && mood!=="sad") {recommendedSong= "Break My Soul by Beyonce";}
